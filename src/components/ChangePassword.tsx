...
export const ChangePassword = ({ onClose }: ChangePasswordProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Помилка при зміні пароля. Перевірте поточний пароль.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <AnimatePresence mode="wait">
      ...
      >
        <motion.div
          ...
          className="bg-gray-100 dark:bg-background-dark rounded-xl shadow-xl w-full max-w-md relative"
        >
            ...
            <div className="p-6 border-t border-gray-200 dark:border-gray-700">
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? 'Змінюю...' : 'Змінити пароль'}
                </button>
              </div>
            </div>
          </div>
